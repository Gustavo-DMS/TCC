...
const validacao = z.object({
    usuario: z.string().min(6, { message: "Insira um e-mail válido" }),
    email: z.string().email({ message: "Insira um e-mail válido" }),
    senha: z.string().min(6, { message: "Insira uma senha válida" }),
    senha_confirmacao: z.string().min(6, { message: "Insira uma senha válida" }),
});
...
export default function Login() {
    ...
    return (
        <div className="flex flex-col flex-grow text-black">
            ...
            <div className="flex relative flex-col p-2 px-10 m-auto bg-white rounded-xl shadow-xl w-5/8 min-w-[20rem]">
                {mensagemErro && (
                ...
                <h1 className="py-5 text-3xl font-bold text-center">Cadastre-se</h1>
                ...
                >
                    ...
                    <button className="py-2 px-5 m-4 mx-auto text-xl font-bold text-white uppercase bg-gradient-to-tr from-blue-500 rounded-lg to-[#493960]">
                        Cadastrar
                    </button>
                </form>
            </div>
